		...
		if($("#provide-div").length > 0) { // Instructor add items screen
			...
			$("#article-toggle").click(function() {
				...
				if(checkedbox == true) {
					...
					$("#provide-div").html('<div class="line row" style="margin-top:1em;"><div class="span2" style="padding-left:1em;"><p>If the library owns or has access to this item, we&#8217;ll use our copy. If not, we&#8217;ll do our best to get a copy we can use. If you know the call number, that will help us find the item more quickly.</p></div><div id="CallNoDiv2" class="span1">' + CallNo + '</div><style>label[for="CallNumber"]{margin-top:0 !important;}</div>');
					$("#CallNoDiv").html("&nbsp;");
					$("#supply-file").hide();
